...
// Validate checks the field values on GetBasicInfoResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *GetBasicInfoResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetBasicInfoResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetBasicInfoResponseMultiError, or nil if none found.
func (m *GetBasicInfoResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *GetBasicInfoResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return GetBasicInfoResponseMultiError(errors)
	}

	return nil
}

// GetBasicInfoResponseMultiError is an error wrapping multiple validation
// errors returned by GetBasicInfoResponse.ValidateAll() if the designated
// constraints aren't met.
type GetBasicInfoResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetBasicInfoResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetBasicInfoResponseMultiError) AllErrors() []error { return m }

// GetBasicInfoResponseValidationError is the validation error returned by
// GetBasicInfoResponse.Validate if the designated constraints aren't met.
type GetBasicInfoResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetBasicInfoResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetBasicInfoResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetBasicInfoResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetBasicInfoResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetBasicInfoResponseValidationError) ErrorName() string {
	return "GetBasicInfoResponseValidationError"
}

// Error satisfies the builtin error interface
func (e GetBasicInfoResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetBasicInfoResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetBasicInfoResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetBasicInfoResponseValidationError{}
