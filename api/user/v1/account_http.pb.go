...
func _Account_Login0_HTTP_Handler(srv AccountHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, "/user.v1.Account/Login")
...
func _Account_Logout0_HTTP_Handler(srv AccountHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, "/user.v1.Account/Logout")
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Account_GetInfo0_HTTP_Handler(srv AccountHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, "/user.v1.Account/GetInfo")
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Account_GetMenuList0_HTTP_Handler(srv AccountHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, "/user.v1.Account/GetMenuList")
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (c *AccountHTTPClientImpl) GetInfo(ctx context.Context, in *emptypb.Empty, opts ...http.CallOption) (*GetInfoResponse, error) {
	...
	opts = append(opts, http.Operation("/user.v1.Account/GetInfo"))
...
func (c *AccountHTTPClientImpl) GetMenuList(ctx context.Context, in *emptypb.Empty, opts ...http.CallOption) (*GetMenuListResponse, error) {
	...
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation("/user.v1.Account/GetMenuList"))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *AccountHTTPClientImpl) Login(ctx context.Context, in *LoginRequest, opts ...http.CallOption) (*LoginResponse, error) {
	...
	opts = append(opts, http.Operation("/user.v1.Account/Login"))
	opts = append(opts, http.PathTemplate(pattern))
...
func (c *AccountHTTPClientImpl) Logout(ctx context.Context, in *emptypb.Empty, opts ...http.CallOption) (*emptypb.Empty, error) {
	...
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation("/user.v1.Account/Logout"))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "POST", path, in, &out, opts...)
	if err != nil {
		return nil, err
