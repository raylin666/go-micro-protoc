...
const OperationAccountGetBasicInfo = "/user.v1.Account/GetBasicInfo"
const OperationAccountGetInfo = "/user.v1.Account/GetInfo"
const OperationAccountGetMenuList = "/user.v1.Account/GetMenuList"
...
func RegisterAccountHTTPServer(s *http.Server, srv AccountHTTPServer) {
	...
	r.GET("/account/basic_info", _Account_GetBasicInfo0_HTTP_Handler(srv))
	r.GET("/account/info", _Account_GetInfo0_HTTP_Handler(srv))
	r.GET("/account/menu_list", _Account_GetMenuList0_HTTP_Handler(srv))
}
...
func _Account_GetBasicInfo0_HTTP_Handler(srv AccountHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in emptypb.Empty
		if err := ctx.BindQuery(&in); err != nil {
			return err
		}
		http.SetOperation(ctx, OperationAccountGetBasicInfo)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.GetBasicInfo(ctx, req.(*emptypb.Empty))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*GetBasicInfoResponse)
		return ctx.Result(200, reply)
	}
}
...
func _Account_GetMenuList0_HTTP_Handler(srv AccountHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in emptypb.Empty
		if err := ctx.BindQuery(&in); err != nil {
			return err
		}
		http.SetOperation(ctx, OperationAccountGetMenuList)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
		...
		reply := out.(*GetMenuListResponse)
		return ctx.Result(200, reply)
	}
}

type AccountHTTPClient interface {
	GetBasicInfo(ctx context.Context, req *emptypb.Empty, opts ...http.CallOption) (rsp *GetBasicInfoResponse, err error)
	GetInfo(ctx context.Context, req *emptypb.Empty, opts ...http.CallOption) (rsp *GetInfoResponse, err error)
	GetMenuList(ctx context.Context, req *emptypb.Empty, opts ...http.CallOption) (rsp *GetMenuListResponse, err error)
...
func (c *AccountHTTPClientImpl) GetBasicInfo(ctx context.Context, in *emptypb.Empty, opts ...http.CallOption) (*GetBasicInfoResponse, error) {
	var out GetBasicInfoResponse
	pattern := "/account/basic_info"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationAccountGetBasicInfo))
...
func (c *AccountHTTPClientImpl) GetMenuList(ctx context.Context, in *emptypb.Empty, opts ...http.CallOption) (*GetMenuListResponse, error) {
	var out GetMenuListResponse
	pattern := "/account/menu_list"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationAccountGetMenuList))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
