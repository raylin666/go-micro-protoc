...
type UploadClient interface {
	// 数据流方式上传文件
	StreamUploadFile(ctx context.Context, in *StreamUploadFileRequest, opts ...grpc.CallOption) (*StreamUploadFileResponse, error)
	// 通过URL资源地址方式上传文件
	UrlUploadFile(ctx context.Context, in *UrlUploadFileRequest, opts ...grpc.CallOption) (*UrlUploadFileResponse, error)
}
...
func (c *uploadClient) StreamUploadFile(ctx context.Context, in *StreamUploadFileRequest, opts ...grpc.CallOption) (*StreamUploadFileResponse, error) {
	out := new(StreamUploadFileResponse)
	err := c.cc.Invoke(ctx, "/basic.v1.Upload/StreamUploadFile", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *uploadClient) UrlUploadFile(ctx context.Context, in *UrlUploadFileRequest, opts ...grpc.CallOption) (*UrlUploadFileResponse, error) {
	out := new(UrlUploadFileResponse)
	err := c.cc.Invoke(ctx, "/basic.v1.Upload/UrlUploadFile", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUploadServer) StreamUploadFile(context.Context, *StreamUploadFileRequest) (*StreamUploadFileResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method StreamUploadFile not implemented")
}
func (UnimplementedUploadServer) UrlUploadFile(context.Context, *UrlUploadFileRequest) (*UrlUploadFileResponse, error) {
...
func _Upload_StreamUploadFile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/basic.v1.Upload/StreamUploadFile",
	}
...
func _Upload_UrlUploadFile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/basic.v1.Upload/UrlUploadFile",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Upload_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "basic/v1/upload.proto",
}
